...
export const notes: Note[] = [
	{
		...
		text: 'This document outlines the key milestones and deliverables for the project, ensuring that all team members are aligned on expectations and deadlines. By following this roadmap, we can track progress effectively and make necessary adjustments along the way. Each phase is carefully planned to mitigate risks and optimize resources, providing a structured approach that enhances productivity and collaboration. Regular updates will be provided to keep stakeholders informed and address any concerns that may arise throughout the development process.'
	},
	{
		id: 'a2',
		bookmark: {
		...
		text: 'During the sprint review meeting, the team discussed recent accomplishments, challenges faced.'
	},
	{
		id: 'a3',
		bookmark: {
	...
	},
	{
		...
		text: 'Optimizing performance is crucial for delivering a seamless user experience. This document outlines various strategies, including code-splitting, caching mechanisms, and efficient database queries. By identifying bottlenecks early and implementing best practices, we can significantly enhance application speed and responsiveness. Regular performance audits help in maintaining an optimal balance between functionality and efficiency. The adoption of modern tools and methodologies plays a key role in ensuring smooth and scalable system performance.'
	},
	{
		id: 'a5',
		bookmark: {
	...
	},
	{
		...
		text: 'Creating a structured content strategy helps ensure consistency across various communication channels. This plan covers content creation, distribution, and optimization techniques to enhance engagement and reach. By aligning content with business goals and audience needs, we can maximize its impact. Regular performance analysis allows us to refine our approach and adapt to evolving trends. Effective storytelling and data-driven insights play a key role in crafting compelling content that resonates with our target audience.'
	},
	{
		id: 'a9',
		bookmark: {
...
export const notePreviews: NotePreview[] = notes.map((note) => ({
	...note,
	text: undefined,
